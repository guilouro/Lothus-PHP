...
<body>
	...
	<form class="form-inline" id="upl" name="upl" action="<?= str_replace('dialog-v4.php','', $_SERVER['PHP_SELF']) ?>ci/index.php/upload/english" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
