...
| -------------------------------------------------------------------*/
	...
	// $nopath = str_replace('js/tinymce/plugins/jbimages/ci/index.php/blank','', $_SERVER['PHP_SELF']);
	$nopath = explode("js/tinymce/", $_SERVER['PHP_SELF']);
	$config['img_path'] = $nopath[0].'files'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]

	// echo "<script>console.log('{$config['upload_path']}')</script>";
