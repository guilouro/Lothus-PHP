...
<body>
	...
	<form class="form-inline" id="upl" name="upl" action="<?= str_replace('dialog.php','', $_SERVER['PHP_SELF']) ?>ci/index.php/upload/{#jbimages_dlg.lang_id}" method="post" enctype="multipart/form-data" target="upload_target" onsubmit="jbImagesDialog.inProgress();">
